...
<%
	...
	PreparedStatement q = con.prepareStatement("SELECT * FROM AlertTable WHERE FK_username=? AND alertType = 'Auto'");
	...
	if(resultOrig.first() == false){
		out.print("<p>");
		out.print(userID + " has not made any valid Auto Bid alerts!");
		out.print("<p>");
